...
description: This comprehensive guide walks you through the process of documenting a mock delivery API using an OpenAPI Spec generator and is published on GitBook
slug: /mock-delivery-api-openapi-gitbook
date: 2026-04-16
...
![img-1-Insert-end-point-details](./img/Insert-end-point-details.png)

### Output

The output below shows a fully documented API endpoint, including:
...
![img-2-Inserted-end-point](./img/Inserted-end-point.jpg)

![img-3-Response](./img/Response.png)
...
- Add the **Bearer Token** in the Authorization section
  ...
  ![Image four-select-bearer-token](./img/select-bearer-token.png)

### Output

This shows the output after clicking the send button; it provides a full list of all delivery records.

![Image five-response-200](./img/response-200.png)
...
- Click **Send** to retrieve the specific record.
  ...
  ![Image six-path-parameter-details](./img/path-parameter-details.png)

### Output

The image below shows the response after the request was sent. It retrieves only the delivery record with an ID of 2.

![Image seven-delivery-response-200](./img/delivery-response-200.png)


After documenting all endpoints, download the OpenAPI specification file.


![Image Eight-download-open-api-spec](./img/download-open-api-spec.png)

## Step 4 - Publishing on GitBook

Go to [GitBook](https://www.gitbook.com/) and navigate to the OpenAPI tab on the left side section, as shown in the following image.
...
![Image Nine-upload-open-api-spec-on-mintlify](./img/upload-open-api-spec-on-mintlify.png)
...
![Image Ten-published-docs](./img/published-docs.png)
