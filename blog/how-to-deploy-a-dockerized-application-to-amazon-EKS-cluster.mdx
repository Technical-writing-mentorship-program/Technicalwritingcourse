...
<img
  src="https://dev-to-uploads.s3.amazonaws.com/uploads/articles/q6kahlgsssyon3l6amrl.png"
  alt="Amazon EKS Cover Image"
/>
...
```bash
1 git clone https://github.com/GoogleCloudPlatform/kubernetes-engine-samples.git
```
...
- **Create an ECR repository**. Navigate to the AWS console and search for ECR. Click on **Get Started**. Give the repository a name and leave the other settings as default. Once you’re done, click on **Create repository**.
  ...
  <img
    src="https://dev-to-uploads.s3.amazonaws.com/uploads/articles/rgm64negf57aazzf3vlv.png"
...
- **Authenticate Docker to the ECR registry**:
  ...
  <img
    src="https://dev-to-uploads.s3.amazonaws.com/uploads/articles/fp2ya0sslkxfp4yeu5op.png"
    alt="View Push Commands"
...
- **Push the Docker image to ECR**:
  ...
  <img
    src="https://dev-to-uploads.s3.amazonaws.com/uploads/articles/bx3fnhv9uimu0h3k4xgz.png"
    alt="ECR Repository Image"
...
<img
  src="https://dev-to-uploads.s3.amazonaws.com/uploads/articles/x6e37po6x898ue7q53lp.png"
  alt="EKS Cluster"
...
<img
  src="https://dev-to-uploads.s3.amazonaws.com/uploads/articles/o6nlbl8q4tts1guisxye.png"
  alt="Load Balancer"
...
<img
  src="https://dev-to-uploads.s3.amazonaws.com/uploads/articles/09xdwxydsub9qe5mmaq6.png"
  alt="Application"
