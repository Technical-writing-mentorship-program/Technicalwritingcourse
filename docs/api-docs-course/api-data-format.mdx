...
- [**YAML Guide by Redocly**](https://redocly.com/learn/yaml): If you are looking for a quick and easy guide to YAML, then this course is perfect for you. It contains detailed examples of how to use YAML syntax.
