...
---
import openapi from './img/openapi.png';
...
<figure>
  <img src={openapi} alt="Structure of an API Specification"/>
  <figcaption>Structure of an API Specification</figcaption>
</figure>
...
<figure>
  <img src={swagger} alt="Swagger image preview" width="100%" />
  <figcaption> Swagger image preview </figcaption>
</figure>
...
<figure>
  <img src={raml} alt="RAML github playground" width="100%"/>
  <figcaption> RAML Github Playground </figcaption>
</figure>
#### RAML Tools
...
<figure>
  <img src={apiary} alt="Apiary preview" width="100%"/>
  <figcaption> Apiary API Documentation Preview</figcaption>
</figure>
