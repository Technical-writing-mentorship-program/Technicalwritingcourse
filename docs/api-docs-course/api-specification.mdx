...
![Structure of an API Specification](IMAGE/openapi3structure.png)
...
![Preview of swagger editor](IMAGE/swaggerEditor.png)
...
![Preview of Raml Playground](IMAGE/RamlPlayground.png)
...
![Apiary Preview](IMAGE/apiaryPreview.png)
