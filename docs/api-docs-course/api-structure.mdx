...
<figure>
  <img src={rawg} width="100%"/>
  <figcaption> RAWG API Introduction Page</figcaption>
</figure>
## Quick Start
...
<figure>
  ...
  <img src={tmdb}
      ...
      width="100%"
    />
  <figcaption> TMDB API Quickstart Quide</figcaption>
</figure>
...
<figure>
   <img src={interswitch}
    alt="interswitch image"
    width="100%"
   />
  <figcaption> Interswitch API Authentication Page </figcaption>
</figure>
...
<figure>
  ...
  width="100%"
  />
  <figcaption>  Paystack API Error Page </figcaption>
</figure>
## Rate Limiting
...
<figure>
  <img 
    ...
    width="100%"
  />
  <figcaption> Twitter API Rate Limit Page</figcaption>
</figure>
