---
slug: /advanced-syntax-formatting-in-markdown
...
:::tip[What you'll cover in this lesson]
...
<details>
  <summary> Preview</summary>
  <p>
    To print "Hello, World!" in Python, use the command `print("Hello,
    World!")`.
  </p>
</details>
...
> Note: if you don't put spaces before the code. The code will not be rendered; you’ll
get a black space.
...
<details>
  <summary> Preview </summary>
  <p>This <mark>text</mark> is <mark>highlighted</mark>.</p> 📝Note: There should be no space between the equal signs and text; otherwise,
  the equal signs will be treated as text
</details>
...
Once a heading has an ID, you can create a link that jumps to that heading within the same document.
    ...
    [Go to Code blocks Section](#code-blocks)

**Rendered:**  
&nbsp;&nbsp;&nbsp;&nbsp;[Go to Code blocks Section](#code-blocks)  
When you click this link, it will take you directly to the heading you created earlier with the ID `code blocks`.
...
<details>
  <summary> Preview</summary>
  <p>[This is an external link to Google ](https://google.com/)</p>
</details>
...
<Quiz
  questions={[
    {
      text: 'How do you highlight a text in Markdown?',
      options: [
        { value: '1', label: 'Wrap the text in between two equal (==test==) symbols' },
        { value: '2', label: 'Wrap the text in between two quotes (""test"") symbols' },
        { value: '3', label: 'Wrap the text in between two asterisks (**test**) symbols' },
        { value: '4', label: 'Wrap the text in between two underscore (__test__) symbols' }
      ],
      correct: '1'
    },
    {
      text: 'Which of the following can used to create a collection of terms and their meanings?',
      options: [
        { value: '1', label: 'Unordered lists' },
        { value: '2', label: 'Indented lists' },
        { value: '3', label: 'Ordered lists' },
        { value: '4', label: ' Definition lists' }
      ],
      correct: '4'
    }
  ]}
...
In 250 words, explain how to create and format tables in Markdown, including:

- Basic table structure
- Text alignment options
- Handling special characters
- Include practical examples using proper Markdown syntax to demonstrate each concept.


**Evaluation criteria**
- Correct table syntax usage
- Clear explanation of alignment options
- Proper handling of special characters like pipes (\|)
- Overall table readability

After review, make a post and tag @TechnicalWriting6 on Twitter to the link to your document.
