...
:::tip[In this lesson, you will learn]
...
:::note
Both format will render your table correctly. However, it is useful when editing your markdown file and sharing it with others.
...
[![Django framework logo](img/django.png)](https://docs.djangoproject.com/en/5.1/)
```
...
<details>
  ...
  <p>
     ...
     [![Django framework icon](img/django.png)](https://docs.djangoproject.com/en/5.1/)
...
<Quiz
	questions={[
		{
			text: "Which of following statements will be displayed as heading 1 in Markdown?",
			options: [
				{
					value: "a",
					label: "#### What is Markdown?",
				},
				{ value: "b", label: "# Consistent Formatting in Technical Writing" },
				{ value: "c", label: "### Markdown is a Markup Language" },
				{ value: "d", label: "## Popular Style Guides in Technical Writing" },
			],
			correct: "b",
		},
		{
			text: "Which of the following is not a tool for Markdown formatting?",
			options: [
				{ value: "a", label: "StackEdit" },
				{ value: "b", label: "GhostWriter" },
				{ value: "c", label: "Dillinger" },
				{ value: "d", label: "Git" },
			],
			correct: "d",
		},
...
1. **Dillinger:**
   ...
   ![A screenshot of Dillinger markdown editor](img/dillinger.png)

_**Fig 1.** Start writing with Dillinger_
...
2. **Typora:**
   ...
   ![A screenshot of Typora features section](img/Typora.png)
_**Fig 2.** Start writing with Typora_
...
3. **StackEdit:**
   ...
   ![A screenshot of StackEdit home page](img/StackEdit4.png)

_**Fig 3.** Welcome to StackEdit_
...
4. **Ghostwriter:**
   ...
   ![A screenshot of Ghostwriter markdown editor](img/ghostwriter.png)

_**Fig 4.** Start writing with GhostWriter_
...
5. **Mou:**
   ...
   ![A screenshot of how to download Mou markdown editor.](img/mou.PNG)

_**Fig 5.** Start writing with Mou editor_
...
- Explain how Consistent formatting can be achieved in Markdown.**

- In your answer, use any of the guides listed in the tutorial.
