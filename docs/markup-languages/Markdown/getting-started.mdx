...
Here is saying “_The best way to learn is to practice_” This way you will be able to identify common errors and avoid them in your next project. In this lesson, you will be doing a lot of practicals and getting your hands dirty in markdown.

:::tip[In the lesson, you will learn]
...
In this lesson, you will use StackEdit. StackEdit is a free online Markdown editor with a visual toolbar for formatting (bold, emphasis, lists, etc.). It can sync with cloud storage services such as Dropbox and Google Drive, and import files from a URL or your computer's hard drive.

1. Visit [StackEdit](https://stackedit.io/).
2. Click on `Start Writing` at the top of the page.

![start writing](img/stackedit.png)

_**Fig 1.** Start Writing in StackEdit_

You will see a welcome file that contains various Markdown syntax and its usage together with the outcome on the right hand.

![Welcome file](img/stackedit2.png)

_**Fig 2.** Welcome file in StackEdit_
...
![create a new file or folder](img/stackedit3.png)
_**Fig 3.** Create a new file or folder in StackEdit_
...
You can add emphasis in markdown either as a **Bold text** or _Italic text_. This can be achieved using **asterisk(s).**
...
:::note
For nested listing either as an ordered or unordered list, maintain the same syntax and add extra spacing before nest items e.g Press the space bar four times before you begin the nest list.
:::
...
<u>
  <b>The outcome is [Google](http://www.google.com)</b>
</u>
...
```markdown
![Stellar Bridge illustration](img/stellerBridge.png "stellar")
```

The output will look like this ⬇️

![Stellar Bridge illustration](img/stellerBridge.png)
_**Fig 4.** Stellar Bridge illustration_
...
- **H1** are best suitable for Title or Main Heading. This is the most prominent heading level and should be used sparingly, typically once per page.
...
<details>
  <summary>Toggle to preview the output</summary>
...
<Quiz
  questions={[
    {
      text: 'How do you add images in Markdown?',
      options: [
        { value: '1', label: '(https://google.com/getting-started/)[Home Page]!' },
        { value: '2', label: '(https://google.com/getting-started/)![Home Page]' },
        { value: '3', label: '[Home Page]!(https://google.com/getting-started/)' },
        { value: '4', label: '![Home Page](https://google.com/getting-started/)' }
      ],
      correct: '4'
    },
    {
      text: 'How do you center align texts in a Markdown table?',
      options: [
        { value: '1', label: 'add : on both sides of the hypens within the header row' },
        { value: '2', label: 'add : on the left side of the hypens within the header row' },
        { value: '3', label: 'add : on the right side of the hypens within the header row' },
        { value: '4', label: ' do not add : on either sides of the hypens within the header row' }
      ],
      correct: '1'
    }
  ]}
...
In 300 words, describe how to set up and use Markdown for technical documentation, focusing on the three most essential formatting elements covered in the guide. Include practical examples using proper Markdown syntax to demonstrate:

- How to create document headers and organize content hierarchy
- How to emphasize text appropriately
- How to create either ordered or unordered lists

Support your explanation with code examples 

After review, make a post and tag @TechnicalWriti6 on Twitter to the link to your document.
