...
:::tip[In this course you will learn the following]
...
![Markdown syntax](img/markdown1.jpg)

_**Fig 1.** Examples of markdown syntax_

![Markdown syntax](img/markdown2.png)

_**Fig 2.** Examples of markdown syntax_
...
Using this software allows you to make changes directly by clicking on buttons to format text and changes are visible immediately.



### Which to Choose?
Markdown and WYSIWYG share some similarities and also have their unique differences.
...
![introduction to markdown](img/markdown3.jpg)

_**Fig 3.** An example of WYSIWYG editor called google docs_

There you see the toolbox with several options to change your text.
...
<Quiz
  questions={[
    {
      text: 'What is a key difference between Markdown and WYSIWYG editors?',
      options: [
        { value: '1', label: 'Markdown requires special software to run' },
        { value: '2', label: 'WYSIWYG allows real-time formatting preview' },
        { value: '3', label: 'Markdown uses drag-and-drop formatting' },
        { value: '4', label: 'WYSIWYG is a lightweight markup language' }
      ],
      correct: '2'
    },
    {
      text: 'Why is Markdown often preferred in technical documentation?',
      options: [
        { value: '1', label: 'It supports complex animations' },
        { value: '2', label: 'It allows for heavy image editing' },
        { value: '3', label: 'It ensures clean, readable, and portable content' },
        { value: '4', label: 'It is compatible only with Windows systems' }
      ],
      correct: '3'
    }
  ]}
...
Markdown and WYSIWYG editors offer two very different approaches to formatting content. Drawing from your understanding of both tools, compare and contrast their use in professional documentation. 

In your response, highlight the trade-offs between simplicity and functionality, and explain which editor you would choose for a collaborative technical writing project—and why.

**Guidelines**

- Write at least 200 words

- Use specific examples from the page (e.g., GitHub, Google Docs, etc.)

- Demonstrate critical thinking by weighing pros and cons
