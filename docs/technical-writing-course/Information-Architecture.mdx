...
![Information architecture and taxonomy working together to deliver content efficiently in an e-commerce platform](../../static/img/ia-taxonomy-example.png)
...
![Global navigation system of Kubernetes' documentation website](../../static/img/global-nav-system-example.png)
...
![Local navigation and search functionality on Kubernetes documentation website](../../static/img/local-search-nav-example.png)
