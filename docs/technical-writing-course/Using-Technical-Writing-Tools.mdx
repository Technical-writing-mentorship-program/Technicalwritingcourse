...
_**Figure 1:** User uploading document into Grammarly_
...
_**Figure 2**: Grammarly suggestions appearing_
...
_**Figure 3**: User reviewing suggestions_
...
_**Figure 4**: User downloading edited document_
...
_**Figure 1**: Duplichecker user homepage_
![Duplichecker Text](../technical-writing-course/img/duplichecker-text.png)
_**Figure 2**: User adds a paragraph to the textbox_
...
_**Figure 3**: User’s plagiarism score appears_
...
_**Figure 3**: User downloads annotated image_
...
_**Figure 1**: User downloads Keyboard Surfer’s Chrome Extension_
...
_**Figure 2**: Keyboard Surfer shows results of user’s search_
...
_**Figure 4**: Highlighted text appears on user’s profile page_
...
<iframe
  width="100%"
  height="315"
  src="https://www.youtube.com/watch?v=8-gJmNPlanw&t=602s"
...
[![Introduction to Markdown](../technical-writing-course/img/intro-to-markdown-promo.jpg)](https://www.youtube.com/watch?v=8-gJmNPlanw&t=602s)
