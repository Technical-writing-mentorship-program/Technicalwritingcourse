...
Technical writing tools are used in creating, editing, formatting, and managing technical content. These tools aid writing and save time.
...
Grammar tools are software applications that identify and fix spelling, punctuation, syntax, and usage mistakes in your writing. They can assist you in making your write-up clear, accurate, and consistent.
...
[Grammarly](https://www.grammarly.com/) is an AI application that provides writing advice in real-time. Grammarly is the most popular grammar tool. It offers tips and suggestions. Grammarly also fixes mistakes and reduces time spent proofreading. Lastly,it helps to increase writing quality and boost your confidence in writing.
...
According to the [Oxford Dictionary](https://www.oed.com/dictionary/plagiarism_n?tab=factsheet#29927356), Plagiarism is the practice of taking someone else's work or ideas and passing them off as one's own. Plagiarism tools are used to check if you presented ideas from another source as your own, and it's prohibited in all types of writing, including technical writing. Some plagiarism tools are **Duplichecker**, **Quetext**, and **Plagiarism Detector**.


### 1. Duplichecker

[Duplichecker](https://www.duplichecker.com/) is a free tool used to identify plagiarized content. It is an essential and efficient tool for writers to identify text and documents that have been plagiarized. Duplichecker provides the links to the source text that has been plagiarized. It offers the free version and premium version. Duplicker’s free plan allows you to check plagiarized content for 1000 words.

### 2. Quetext

[Quetext](https://www.quetext.com/) is a plagiarism detector used by academics, professionals, and writers. It allows 500 words for the free version and 100,000 words per month for Premium and Enterprise users. The QueText checker is capable of processing languages beyond English. It can do plagiarism searches in multiple languages, including French, Spanish, Italian, Portuguese, German, Arabic, and Russian.

### 3. Plagiarism Detector

[Plagiarism Detector](https://plagiarismdetector.net/) is an accurate and free online plagiarism detector.
All you have to do is copy and paste text to identify plagiarized content. Plagiarism Detector offers the free version and the Pro version. The free version works for 1000 words for the free plan and $8 monthly for the premium version.

:::tip[Plagiarism Detector features]
- File Upload
- Quick Search
- Deep Search
- Multiple languages
...
[Microsoft Word](https://www.microsoft.com/en-us/microsoft-365/word) is a web, mobile, and desktop application built by Microsoft to create and edit documents. It can be accessed using Windows or a Mac. Microsoft Word is a vast tool for creating and formatting technical documents. It offers capabilities like styles, templates, and a flexibility that help maintain document consistency and structure.

### 3. Evernote


[Evernote](https://evernote.com/) is a user-friendly app for writers who want to jot down many ideas. Evernote is an excellent software for writers, and it is available for Android, iOS, Windows, and Mac. Evernote allows users to create notes from images and photos.
...
[Adobe Photoshop](https://www.adobe.com/products/photoshop/landpa.html) is a graphics design and photo editing software for images. Adobe Photoshop is a great fit for one who has experience with complex design tools.
...
[Microsoft Designer](https://designer.microsoft.com/) is an AI tool for graphics and pictures to create designs based on the prompts. Microsoft Designer creates images by using prompts and written descriptions. It can be used to make posters, logos, and postings for social networking platforms. It is available as a mobile app and web app.
...
[Notepad++](https://notepad-plus-plus.org/) is a simple source code editor for Windows. It supports various programming languages, including Markdown. You can use Notepad++ to write codes to add to your write-up.
...
Screen capture tools capture images and videos to add to the writeups for better understanding. Technical writing requires using user-interactive videos, GIFs, and pictures. To enhance and increase user engagement, these tools are exceptionally efficient and enable you to capture visually stunning images and videos are essential.
Some well known screen capture tools are:
- SnipIt
- SnagIt
- Loom
...
With Loom, you can also record your screen, audio, and voiceovers.
:::
...
### Journo Portfolio
[Journo Portfolio](https://www.journoportfolio.com/) is a specialized website builder designed for writers and creative professionals to showcase their work. It has a 100% free plan. 
You can automatically import your Medium, Hashnode, and LinkedIn articles.


## Static Site Generators

Static Site Generators (SSGs) are tools that automate the creation of websites by generating pre-built HTML pages from content written in plain text formats like Markdown, reStructuredText, or AsciiDoc. These generated pages are then hosted on a web server, eliminating the need for a complex backend database or server-side scripting.

:::tip

Hugo, Mkdocs, Docusaurus, Gatsby, and Sphinx are the most common static site generators.
:::
...
Hugo offers integration with Google Analytics. Hosting can be done on Gitlab and Github.

Some of the benefits of using Hugo:
- Cross-Platform
- Great Themes
- Fast Build Times
...
- According to [Semrush](https://www.semrush.com/blog/off-page-seo/), off-page SEO shows Google that your website and pages are authoritative and trustworthy.
...
[Google Analytics](https://developers.google.com/analytics) is a web analytics service that, among other things, can be used for search engine optimization (SEO) and marketing objectives.
...
With Glasp, users worldwide can highlight content on various websites and PDFs. Glasp is a mobile app for Android and iOS and an extension for web browsers. You can also see what other users highlighted on your profile page. Glasp offers an extension to highlight and copy transcripts of YouTube videos. Glasp is useful in highlighting online articles or videos. It helps organize thoughts and find online references.
...
:::tip
AI
Some AI tools are ChatGPT, Gemini, and GrammarlyGo.
:::
...
Google developed [Gemini](https://gemini.google.com/), an AI tool to provide writing materials and resources. Gemini refers to websites based on the content it offers for accuracy.

### 3. Grammarly Go

[Grammarly Go](https://www.grammarly.com/ai) is an AI tool integrated with Grammarly to help you quickly write content for clients' emails, articles, and websites.
It helps writers overcome writer's block and generate sentences based on prompts.

## How to use Technical Writing Tools to Create and Edit Technical Documentation
...
### Grammarly
Grammarly works as a web app, a keyboard on mobile devices, and an extension for web browsers. To use Grammarly for web browsers, follow these steps:
...
![Grammarly Homepage](../technical-writing-course/img/grammarly-homepage.png)
_**Figure 1**: Grammarly homepage_

![Grammarly SignUp](../technical-writing-course/img/grammarly-signup-page.png)
_**Figure 2**: Grammarly sign in area_

![Grammarly email](../technical-writing-course/img/grammarly-email.png)
_**Figure 3**: User picking Google as an option sign in area_

![Grammarly Webpage](../technical-writing-course/img/grammarly-webpage.png)
_**Figure 4**: User dashboard_
...
![Grammarly New Document](../technical-writing-course/img/grammarly-new-document.png)
_**Figure 5:** User uploading document into Grammarly_
...
![Accept Grammarly Suggestions](../technical-writing-course/img/accept-grammarly-suggestions.png)
_**Figure 6**: Grammarly suggestions appearing_

3. Check each suggestion it offers and accept it, if it fits in the context of your write-up.
![Accepts Grammarly Suggestions](../technical-writing-course/img/zeroing-in-on-accept-button.png)
_**Figure 7**: User reviewing suggestions_

4. Download the document after making the changes and proofreading.
![Download Grammarly Documents](../technical-writing-course/img/download-grammarly-document.png)
_**Figure 8**: User downloading edited document_
...
![Duplichecker Homepage](../technical-writing-course/img/duplichecker-homepage.png)
_**Figure 9**: Duplichecker user homepage_
![Duplichecker Text](../technical-writing-course/img/duplichecker-text.png)
_**Figure 10**: User adds a paragraph to the textbox_

- It takes a few minutes to load.
- Once it is complete, it shows the percentage of plagiarism.

![Duplichecker Result](../technical-writing-course/img/duplichecker-result.png)
_**Figure 11**: User’s plagiarism score appears_
...
- Open your web browser, and visit Annotely’s website. Select “Start Annotating now.”
  ![Annotely Website](../technical-writing-course/img/annotely-webpage.png)
_**Figure 12**: Annotely’s homepage_
- Drag or drop the image from your device.
  ![Annotely" width](../technical-writing-course/img/drop-file-in-annotely.png)
_**Figure 13**: User drags image into Annotely_
- Annotely has arrows, blur, and text options to add to the photos.
  [Annotely Interface](../technical-writing-course/img/annotely-interface-features.png)

- Download the image once you’re done.  
  ![Download Annotely image](../technical-writing-course/img/download-annotely-image.png)
_**Figure 14**: User downloads annotated image_
...
- On your start bar, search for “snipping tool.”
  ![Snipping Tool](../technical-writing-course/img/snipping-tool-snippet-search.png)
_**Figure 15**: User downloads Snipping Tool from Microsoft App Store_

- Select new and snip the page.
  ![Snipping Tool](../technical-writing-course/img/snipping-tool-setup.png)
_**Figure 16**: User selects & snips image_

- Save it on your PC.
  ![Snip Tool](../technical-writing-course/img/saving-snipped-image.png)
_**Figure 17**: User saves image_
...
- Select “Add to Chrome.”
  ![Keyword Surfer Chrome extension](../technical-writing-course/img/download-keyword-surfer.png)
_**Figure 18**: User downloads Keyboard Surfer’s Chrome Extension_
...
- Search for any keyword, and Keyword Surfer will provide the keywords required.
  ![Keyword Surfer](../technical-writing-course/img/keyword-surfer-showing-results.png)
_**Figure 19**: Keyboard Surfer shows results of user’s search_
...
![Glasp Homepage](../technical-writing-course/img/glasp-homepage.png)
_**Figure 20**: User chooses PDF_
- Choose words to highlight and select the highlight colour. Choose from four colours. Pink, yellow, green, and blue.
![Glasp Homepage](../technical-writing-course/img/glasp-highlighting-words.png)
_**Figure 21**: Text is chosen_
- Once the colour is selected, the text is highlighted.
![Glasp Homepage](../technical-writing-course/img/glasp-highlighted-text.png)
**Figure 22**: Text is highlighted_
- You can access the text highlighted on your profile page on Glasp Website.
![Glasp HomePage](../technical-writing-course/img/post-on-glasp.png)
_**Figure 23**: Highlighted text appears on user’s profile page_
...
- Write in Markdown.
- Watch this [video](https://www.youtube.com/watch?v=8-gJmNPlanw&t=602s) to learn how to write in Markdown 

:::tip[Introduction to Markdown]
