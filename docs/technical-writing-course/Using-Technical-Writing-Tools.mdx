...
[Microsoft Word](https://www.microsoft.com/en-us/microsoft-365/word) is a web, mobile, and desktop application built by Microsoft to create and edit documents. It can be accessed using Windows or a Mac.
...
[Evernote](https://evernote.com/) is a user-friendly app for writers who want to jot down many ideas. Evernote is an excellent software for writers, and it is available for Android, iOS, Windows, and Mac.
...
_**Figure 3**: User’s plagiarism score appears _
...
_**Figure 1**: Intro Markdown course promotional picture_
