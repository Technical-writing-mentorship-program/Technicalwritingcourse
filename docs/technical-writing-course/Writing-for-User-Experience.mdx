...
![Writing for User Experience (UX)](./img/Fig-1-ux-user-experience.jpg)
...
The user interface (UI) is the part of the product where the user can see, touch, and interact. User experience (UX) refers to a person's feelings when interacting with a product.
...
![User satisfaction in technical writing](./img/Fig-2-ux-user-satisfaction.jpg)
...
Writing for user experience is applying UX principles when curating written content. The technical writer's role is to ensure they apply all the UX principles necessary while creating clear and concise documentation for users
...
![Figure 3 - Know your audience before creating content](./img/Fig-3-ux-audience.jpg)
...
![Implement information architecture](./img/Fig-4-ux-information-architecture.jpg)
...
![Use consistent formatting while creating written content](./img/Fig-5-ux-consistent-formatting.jpg)
...
![Use plain language while creating written content](./img/Fig-6-ux-plain-language.jpg)
...
![Make use of interactive elements while writing](./img/Fig-7-ux-interactive-elements.jpg)
...
![User feedback and content update](./img/Fig-8-ux-feedback-update.jpg)
