...
<figure style={{ textAlign: 'center'}}>
  <img 
    src="/img/slack.png" 
      alt="slack's Brand Identity" 
      style={{ width: '100%', maxWidth: '600px', height: 'auto'}} />
  <figcaption><em>Slack's Brand Identity</em></figcaption>
</figure>
...
### 2. Utilize an Existing Publishing Guide
...
<figure style={{ textAlign: 'center'}}>
  <img 
    src="/img/mailchimp.png" 
      alt="Mailchimp's voice and tone" 
      style={{ width: '100%', maxWidth: '600px', height: 'auto'}} />
  <figcaption><em>**Figure 2.** Mailchimp's voice and tone</em></figcaption>
</figure>
...
<figure style={{ textAlign: 'center'}}>
  <img 
    src="/img/shopify-grammar.png" 
      alt="Shopify's grammar and punctuation" 
      style={{ width: '100%', maxWidth: '600px', height: 'auto'}} />
  <figcaption><em>**Figure 3.** Shopify's grammar and punctuation</em></figcaption>
</figure>
...
Many companies have a separate design style guide for visuals and media content, but it's crucial to include essential information on how writers source images.
...
Google search yields several style guide templates, but [Writers.com](https://writer.com/downloads/style-guide-template.txt) offers a particularly neat and recommended template.
