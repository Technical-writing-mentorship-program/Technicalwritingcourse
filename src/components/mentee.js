...
const Mentees = () => {
  ...
  return (
    <Layout title={mentee ? `${mentee.name} - Mentee Profile` : 'Mentee Not Found'}>
              ...
              <div className="flex flex-col md:flex-row w-full min-h-screen">
                ...
                <div className="w-full md:w-2/5 lg:w-1/3 bg-white flex flex-col items-center justify-center p-8 sm:p-12 text-center space-y-6">
                  ...
                  <div className="space-y-2">
                    <h1 className="menteeNameHeader text-2xl md:text-3xl font-mono tracking-widest">
                      &lt;{mentee.name}&gt;
                    </h1>
...

                  {
                    mentee.portfolio &&
                      <button
                        ...
                        onClick={() => window.open(mentee.portfolio, '_blank')}
                      >
                        PORTFOLIO
                      </button>
                  }
                  ...
                  <SocialIcons socials={mentee.socials}/>
                </div>
                ...
                <div className="w-full md:w-3/5 lg:w-2/3 bg-violet-600 flex flex-col items-center justify-center p-8 sm:p-12 text-white text-center md:text-left space-y-8">
                  {/* I want both cards to be aligned vertically */}

                  <div className="text-center max-w-3xl">
                    <h2 className="text-center text-4xl md:text-5xl font-mono mb-6">
                      &lt;/About Me&gt;
                    </h2>
                    <p className="text-center text-violet-100 leading-relaxed">
                      {mentee.bio}
                    </p>
                  </div>
