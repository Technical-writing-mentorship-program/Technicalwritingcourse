...
export default function ProductDocMentees (){
  ...
  return (
    <Layout
      title={`Product Documentation Cohort ${year} Mentees`}
      description={`List of all mentees from the Product Documentation cohort of ${year}`}
    >
      <div className="min-h-screen font-sans text-black dark:text-white p-8 md:p-16 lg:p-24">
        <div className="max-w-7xl mx-auto">
          <header className="text-left mb-16 text-gray-900! dark:text-white!">
            <p className="productCohortsListHeader text-sm text-black tracking-[0.2em] uppercase mb-4">
