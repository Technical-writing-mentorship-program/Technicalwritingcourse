  ...
  return (
    <Layout title="Write for Us" description="Contribute to the TWMP blog and share your knowledge with the community.">
      <main className="container margin-vert--lg">
        ...
        <h2>How to Submit</h2>
        <p>
          Send a short pitch or draft to <a href="mailto:writingt82@gmail.com">writingt82@gmail.com</a>. If it fits, we’ll get back to you within a week with next steps.
        </p>
